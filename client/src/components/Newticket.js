...
const Newticket = (props) => {
  ...
  return (
    <div class="">
      {/* Title */}
      <div className="text-center text-xl font-bold  text-pink-800  p-2 border-2 flex justify-evenly">
      ...
      {/* form component */}
      <form
        className="text-sm w-1/2 mx-auto "
      ...
      >
        ...
        <div className="flex-col mt-5 ">
          ...
          <div className="mt-5 flex-col">
            <p className="text font-bold mt-1">Priority Level:</p>
            <input
              className="bg-white  shadow border  mx-auto"
              placeholder="Describe in detail new bug/issue"
              name="priority"
